...
from organisation.views import  OrganisationRegView, RegisterDomainView
...
urlpatterns = [
    ...
    url(r'^success/$', TemplateView.as_view(template_name='organisation/success.html'), name="register_success"),
